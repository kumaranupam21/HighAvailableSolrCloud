...
#wget https://archive.apache.org/dist/zookeeper/zookeeper-3.6.2/apache-zookeeper-3.6.2-bin.tar.gz -q
 wget https://archive.apache.org/dist/zookeeper/zookeeper-3.5.7/apache-zookeeper-3.5.7-bin.tar.gz -q
...
ln -s /opt/apache-zookeeper-3.5.7-bin /opt/zookeeper
...
chown -R solr:solr /opt/apache-zookeeper-3.5.7-bin
...
ZK_HOST=$host1:2181,$host2:2181,$host3:2181
# comma rest of the hosts ,<host name 2>:2181,<host name 3>:2181
SOLR_LOG_LEVEL=WARN
# set the corrent host
SOLR_HOST=$currHost
#other configs
SOLR_OPTS='$SOLR_OPTS -Dsolr.environment=prod,label=CorpWebsitePROD,color=#ff0000'
SOLR_JAVA_MEM="-Xms2g -Xmx5g"
EOT
